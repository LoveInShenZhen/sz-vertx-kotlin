...
class Fundamental :  ProdEnvBase() {
    ...
    @Test
    fun GetInstruments_by_symbol_test() {
        val req = GetInstrumentsReq.newBuilder().apply {
            symbols = "SHSE.688062"
        }.build()
        val rsp = fundamental_api.getInstruments(req)
    ...
    fun GetInstruments_by_symbols() {
        MeasureTime {
            val req = GetInstrumentsReq.newBuilder().apply {
                symbols = "SHSE.600000,GFEX.SI,SZSE.000565,SZSE.002651,"
            }.build()
    ...
    fun GetDividends_stock() {
        MeasureTime {
            val req = GetDividendsReq.newBuilder().apply {
                symbol = "SZSE.002555"
    ...
    fun GetHistoryInstrument_debug_1() {
        MeasureTime {
            val req = GetHistoryInstrumentsReq.newBuilder().apply {
                symbols = "SZSE.000001"
