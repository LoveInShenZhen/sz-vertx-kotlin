...
@Embeddable
public data class HistoryBarMetaUPK(
...
@Entity
@Table(name = "history_bar_meta")
@DbComment("历史 bar 行情数据文件分发元数据信息表")
public open class HistoryBarMeta() {
  @EmbeddedId
  public lateinit var historyBarMetaUPK: HistoryBarMetaUPK
