...
public class VertxCompletableFuture<T> extends CompletableFuture<T> implements CompletionStage<T> {
     ...
     * @return the new CompletableFuture
     */
    public static <T> VertxCompletableFuture<T> supplyBlockingAsync(Vertx vertx, Boolean ordered, Supplier<T> supplier) {
        return supplyBlockingAsync(Objects.requireNonNull(vertx).getOrCreateContext(), ordered, supplier);
    }

    public static <T> VertxCompletableFuture<T> supplyBlockingAsync(Vertx vertx, Supplier<T> supplier) {
        return supplyBlockingAsync(Objects.requireNonNull(vertx).getOrCreateContext(), false, supplier);
    }
     ...
     * @return the new CompletableFuture
     */
    public static VertxCompletableFuture<Void> runBlockingAsync(Vertx vertx, Boolean ordered, Runnable runnable) {
        return runBlockingAsync(Objects.requireNonNull(vertx).getOrCreateContext(), ordered, runnable);
    }

    public static VertxCompletableFuture<Void> runBlockingAsync(Vertx vertx, Runnable runnable) {
        return runBlockingAsync(Objects.requireNonNull(vertx).getOrCreateContext(), false, runnable);
    }
     ...
     * @return the new CompletableFuture
     */
    public static VertxCompletableFuture<Void> runBlockingAsync(Context context, Boolean ordered, Runnable runnable) {
        Objects.requireNonNull(runnable);
    ...
    public static VertxCompletableFuture<Void> runBlockingAsync(Context context, Runnable runnable) {
        return runBlockingAsync(context, false, runnable);
    }
     ...
     * @return the new CompletableFuture
     */
    public static <T> VertxCompletableFuture<T> supplyBlockingAsync(Context context, Boolean ordered, Supplier<T> supplier) {
        Objects.requireNonNull(supplier);
    ...
    public static <T> VertxCompletableFuture<T> supplyBlockingAsync(Context context, Supplier<T> supplier) {
        return supplyBlockingAsync(context, false, supplier);
    }
