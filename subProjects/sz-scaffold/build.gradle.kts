...
dependencies {
    ...
    api("io.vertx:vertx-core:4.3.7")
    api("io.vertx:vertx-web:4.3.7")
    api("io.vertx:vertx-zookeeper:4.3.7") {
        this.exclude(group="log4j")
    }
    api("io.vertx:vertx-lang-kotlin:4.3.7") {
        this.exclude(group = "org.jetbrains.kotlin")
    }
    api("io.vertx:vertx-lang-kotlin-coroutines:4.3.7") {
        this.exclude(group = "org.jetbrains.kotlin")
    }
